...
public class ToAlgebraicTest {
    ...
    public void testPawn() {
        // White
        ChessGame chessGame = FEN.getGame("8/4kpp1/8/8/8/8/1PPK4/8 w - - 0 1");
        ...
        // Black
        chessGame = FEN.getGame("8/4kpp1/8/8/8/8/1PPK4/8 b - - 0 1");
        ...
        // En Passant
        chessGame = FEN.getGame("r3kb1r/pp2p1pp/3qb3/1PpPP3/4n3/1n1PBPPB/P1Q5/RN2K1NR w KQkq c6 0 16");
    ...
    public void testPromotion() {
        // White
        ChessGame chessGame = FEN.getGame("8/5P2/k7/8/8/K7/5p2/8 w - - 0 1");
        ...
        // Black
        chessGame = FEN.getGame("8/5P2/k7/8/8/K7/5p2/8 b - - 0 1");
    ...
    public void testCastling() {
        // White
        ChessGame chessGame = FEN.getGame("r3k2r/pppppppp/8/8/8/8/PPPPPPPP/R3K2R w KQkq - 0 1");
        ...
        // Black
        chessGame = FEN.getGame("r3k2r/pppppppp/8/8/8/8/PPPPPPPP/R3K2R b KQkq - 0 1");
    ...
    public void testAmbiguity() {
        // No Ambiguity
        ChessGame chessGame = FEN.getGame("8/8/4n3/8/8/5r2/8/k1K5 b - - 0 1");
        ...
        // Similar File
        chessGame = FEN.getGame("8/4R3/8/8/8/4R3/8/k1K5 w - - 1 1");
        ...
        // Similar Rank
        chessGame = FEN.getGame("8/8/8/2R3R1/8/8/8/k1K5 w - - 2 1");
        ...
        // Both
        chessGame = FEN.getGame("8/8/4Q1Q1/8/4Q1Q1/8/8/k1K5 w - - 3 1");
        ...
        // Knights
        chessGame = FEN.getGame("r1bqk2r/1p2ppbp/p1np1np1/2p5/4P3/PBNP3P/1PP2PP1/R1BQK1NR w KQkq - 7 10");
    ...
    public void testCapture() {
        // White
        ChessGame chessGame = FEN.getGame("8/8/8/4p1R1/8/4r1P1/8/k1K5 w - - 1 2");
        ...
        // Black
        chessGame = FEN.getGame("8/8/8/4p1R1/8/4r1P1/8/k1K5 b - - 1 2");
    ...
    public void testChecks() {
        // White
        ChessGame chessGame = FEN.getGame("8/8/2R5/1R6/8/k5r1/7r/3K4 w - - 1 2");
        ...
        // Black
        chessGame = FEN.getGame("8/8/2R5/1R6/8/k5r1/7r/3K4 b - - 1 2");
    ...
    public void testPromotion_Capture_Checkmate() {
        // White
        ChessGame chessGame = FEN.getGame("2q2k2/1P5R/8/8/8/8/1p5r/2Q2K2 w - - 1 2");
        ...
        // Black
        chessGame = FEN.getGame("2q2k2/1P5R/8/8/8/8/1p5r/2Q2K2 b - - 1 2");
