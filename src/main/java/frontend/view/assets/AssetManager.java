...
public class AssetManager {
    ...
    private void loadCursor(String path, String name) {
        Toolkit toolkit = Toolkit.getDefaultToolkit();
        Cursor grabCursor = toolkit.createCustomCursor(ImageLoader.renderSVGToBufferedImage(path, 32, 32), new Point(16, 16), name);
        cursors.put(name, grabCursor);
    }

    private void loadCursors() {
        loadCursor("cursors/grab.svg", "grab-cursor");
        loadCursor("cursors/grabbing.svg", "grabbing-cursor");
    }
